...
return [
    'enabled' => [
        ...
        'type' => 'checkbox',
        'label' => __('Enable Centrobill MyBank', 'woocommerce-gateway-centrobill'),
    ...
    'title' => [
        ...
        'default' => __('MyBank', 'woocommerce-gateway-centrobill'),
        'desc_tip' => true,
    ],
    'description' => [
        ...
        'default' => __('You will be redirected to MyBank', 'woocommerce-gateway-centrobill'),
    ],
];
