...
return [
    'enabled' => [
        ...
        'type' => 'checkbox',
        'label' => __('Enable Centrobill Giropay', 'woocommerce-gateway-centrobill'),
    ...
    'title' => [
        ...
        'default' => __('Giropay', 'woocommerce-gateway-centrobill'),
        'desc_tip' => true,
    ],
    'description' => [
        ...
        'default' => __('You will be redirected to Giropay', 'woocommerce-gateway-centrobill'),
    ],
];
