...
return [
    'enabled' => [
        ...
        'type' => 'checkbox',
        'label' => __('Enable Centrobill Przelewy24', 'woocommerce-gateway-centrobill'),
    ...
    'title' => [
        ...
        'default' => __('Przelewy24', 'woocommerce-gateway-centrobill'),
        'desc_tip' => true,
    ],
    'description' => [
        ...
        'default' => __('You will be redirected to Przelewy24', 'woocommerce-gateway-centrobill'),
    ],
];
